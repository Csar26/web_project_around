...
export const popupProfile = document.querySelector(".popup_content_edit-profile");
...
export const closeButtonImage = popupImage.querySelector(".popup__button-close");
export const addButton = document.querySelector(".add-button");
export const popupAddElement = document.querySelector(".popup_content_add-element");
...
export const overlays = Array.from(document.querySelectorAll(".popup__overlay"));
